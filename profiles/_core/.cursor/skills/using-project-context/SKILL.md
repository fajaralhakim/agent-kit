...
description: Reads AGENTS.md and the .agents/ guides before scaffolding or large changes. Use when starting new work or touching unfamiliar areas.
---
...
4. Read the specific layer guide under `.agents/layers/` only when working in that layer.
5. Inspect existing code in the same area and follow established patterns.

Rules in your harness folder (`.cursor/rules/`, `.claude/rules/`, etc.) were generated from this project's scan — respect their globs and conventions.
